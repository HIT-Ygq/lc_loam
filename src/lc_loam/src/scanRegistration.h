...
class scanRegistration
{
    public:
		...
		void featureExtraction(const pcl::PointCloud<common::PointType>::Ptr &pc_in,
							   pcl::PointCloud<pcl::PointXYZI>::Ptr &pc_out_edge,
							   pcl::PointCloud<pcl::PointXYZI>::Ptr &pc_out_surf);
		void featureExtractionFromSector(const pcl::PointCloud<common::PointType>::Ptr& pc_in,
